...
domReady(
  (function enableCssMediaQueries() {
    ...
    var nativeSupport = function() {
      ...
      el.id = id;
      var style = cssHelper.addStyle(
        "@media all and (width) { #" + id + " { width: 1px !important; } }",
        [],
        false
    ...
    var testMediaFeature = function(feature, value) {
      ...
      if ("device-width" === feature.substring(l - 12, l)) {
        ...
        // viewport width
        width =
          document.documentElement.clientWidth || document.body.clientWidth; // the latter for IE quirks mode
        if (value !== null) {
          if (valueType === "length") {
            return (
              (min && width >= amount) ||
